...
package object jdbc {
  ...
  private[jdbc] val currentTransactionIsolationLevel: FiberRef[TransactionIsolationLevel] =
    FiberRef.unsafe.make[TransactionIsolationLevel](TransactionIsolationLevel.None)(Unsafe.unsafe)
}
